...
class HabilitacionWindow(ttk.Frame):
    def __init__(self, parent, connection=None):
        """
        Inicializa la ventana de Habilitación.
        ...
        self.template_path = resource_path("formatos/habilitacion_con_template.docx")
    ...
    def setup_ui(self):
        ...
        self.parent.title("Habilitación Con Titulo Internacional - SPS")
        ...
        self.lbl_detalle = ttk.Label(
            self.detalle_frame,
            text="4 Cursos OMI(1.13, 1.21, 3.26, BSFA)",
            font=("Arial", 10)
        )
    ...
    def actualizar_detalle_cursos(self, *args):
        ...
        if self.ejercicios_practicos_var.get():
            detalle = "5 Cursos OMI básicos"
        else:
            detalle = "4 Cursos OMI(1.13, 1.21, 3.26, BSFA)"
    ...
    def generar_documento(self):
        """
        Genera el documento de Habilitación Con Título y lo registra en tramitaciones
        """
        ...
        try:
            ...
            id_tipo_tramite, doc_num = create_document_for_tramitacion(
                conn, 
                id_tramitacion, 
                "HABILITACION CON TITULO"  # Código para Habilitación Con Título
            )
    ...
    def crear_documento_word(self, doc_num):
        ...
        try:
            ...
            detalle = "5 Cursos OMI básicos" if self.ejercicios_practicos_var.get() else "4 Cursos OMI(1.13, 1.21, 3.26, BSFA)"
    ...
    def guardar_documento(self, doc, doc_num):
        ...
        try:
            default_filename = f"habcon_{doc_num}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
