...
class HabilitacionSinWindow(ttk.Frame):
    def __init__(self, parent, connection=None):
        """
        Inicializa la ventana de Habilitación Sin Título.
        ...
        self.template_path = resource_path("formatos/habilitacion_sin_template.docx")
    ...
    def setup_ui(self):
        ...
        self.parent.title("Habilitación Sin Titulo Internacional - SPS")
    ...
    def generar_documento(self):
        """
        Genera el documento de Habilitación Sin Título y lo registra en tramitaciones
        """
    ...
    def guardar_documento(self, doc, doc_num):
        ...
        try:
            default_filename = f"habsin_{doc_num}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.docx"
