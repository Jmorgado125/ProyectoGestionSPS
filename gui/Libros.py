...
class LibrosManager:
    ...
    def setup_main_window(self):
        ...
        try:
            self.window.iconbitmap("assets/logo1.ico")
        except:
            pass
    ...
    def crear_libro(self, id_carpeta):
        ...
        try:
            dialogo.iconbitmap("assets/logo1.ico")
        except:
            pass
        dialogo.grab_set()
    ...
    def cargar_alumnos(self):
        """Carga la lista de alumnos del curso"""
        try:
            conn = connect_db()
            cursor = conn.cursor(buffered=True)
            ...
            cursor.execute("""
                ...
                JOIN inscripciones i ON cl.id_curso = i.id_curso
            ...
            for alumno in cursor.fetchall():
                self.asistencia_tree.insert(
                    "", "end",
                    values=(alumno[3], "PRESENTE")  # Usando el nombre_completo concatenado
                )
    ...
    def mostrar_calendario(self):
        ...
        try:
            top.iconbitmap("assets/logo1.ico")
        except:
            pass
